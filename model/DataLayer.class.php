...
class DataLayer{
     ...
     */
    /*
    function createCustomers($pseudo,$prenom,$nom,$sexe,$email,$password){
        $sql = "INSERT INTO customers (sexe,pseudo,prenom,nom,email,password) VALUES (:sexe,:pseudo,:prenom,:nom,:email,:password)";
        try {
